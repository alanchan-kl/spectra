...
/**
 * Write Allure `environment.properties` from the resolved config, so the report's
 ...
 * Credentials are deliberately omitted. CI run provenance (commit/branch/run) is
 * appended later in report.yml from the GitHub context.
 */
